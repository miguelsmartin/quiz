...
exports.index = function(req, res, next) {
    ...
    if(req.query.search !== undefined){
    	...
    	models.Quiz.findAll({where: {question: {$like: ('%' + searchAux + '%')}}, order: ['question'], include: [models.Comment, models.Attachment]}).then(
			function(quizzes) {
...
// Autoload el quiz asociado a :quizId
 exports.load = function(req, res, next, quizId) { //SIEMPRE QUE QUIZID
 	models.Quiz.findById(quizId, {include: [models.Comment, models.Attachment]}) //SOLICITO QUIZ CON QUIZID Y LE AÑADO SUS COMENTARIOS EN PROPIEDAD COMMENTS
   		.then(function(quiz) {
       		if (quiz) {
         		req.quiz = quiz;
         		next();
