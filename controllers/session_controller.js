...
exports.new = function(req, res, next) {
    ...
    var redir = req.query.redir ||    //COGERIA LA REDIR DE CREATE SI HA FALLADO PARA REINTENTAR PERO VOLVER A URL ORIGINAL
...
exports.create = function(req, res, next) {
    ...
    var redir = req.body.redir || '/'  //PARAMETRO OCULTO QUE LE PASO DESDE POST EN NEW.EJS
    ...
    authenticate(login, password)
        .then(function(user) {
            if (user) {
    	        // Crear req.session.user y guardar campos id y username Y ADMIN (para luego ver si tengo acceso a todo) 
                ...
                res.redirect("/session?redir="+redir);  //LE PASO EN REQ.QUERY.REDIR LA URL  (VER EXPORTS.NEW)
            }
		})
